...
/* HANKE: Changed from parent(".fluid-width-video-wrapper").css("padding-top",100*a+"%") so that video can show correctly */
/* HANKE: Changed from absolute to relative fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:relative;top:0;left:0;width:100%;height:100%;}" */
